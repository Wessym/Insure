...
var DemandeService = /** @class */ (function () {
    ...
    DemandeService.prototype.addDemande = function (obj) {
    ...
    DemandeService.prototype.getAllDemandesWithUsers = function () {
        return this.http.get(this.demandeUrl + "/getAllDemandesWithUsers");
    };
    DemandeService.prototype.getDemandeByUserId = function (idUser) {
        return this.http.get(this.demandeUrl + "/getDemandeByUserId/" + idUser);
    };
    DemandeService.prototype.confirmDemande = function (idDemande, noth) {
        return this.http.put(this.demandeUrl + "/confirmDemande/" + idDemande, noth);
    };
    DemandeService.prototype.rejectDemande = function (idDemande, noth) {
...
var RejectsService = /** @class */ (function () {
    function RejectsService(http) {
        this.http = http;
        this.rejectsUrl = "http://localhost:3000/rejects";
    }
    RejectsService.prototype.addRejection = function (obj) {
        var formData = new FormData();
    ...
    RejectsService.prototype.getRejectionByDemandeId = function (idDemande) {
        return this.http.get(this.rejectsUrl + "/getRejectionByDemandId/" + idDemande);
    };
    RejectsService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
    ]; };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.signup = function (obj, img) {
        var formData = new FormData();
    ...
    UserService.prototype.getUserByAnnonceUserId = function (id) {
...
var AjoutModalComponent = /** @class */ (function () {
    function AjoutModalComponent(formBuilder, router, activatedRoute, demandeService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.demandeService = demandeService;
    }
    AjoutModalComponent.prototype.ngOnInit = function () {
    ...
    AjoutModalComponent.prototype.ajoutDemande = function () {
        var _this = this;
        var idUser = this.connectedUser._id;
        this.demandeForm.value.idUser = idUser;
        this.demandeService.addDemande(this.demandeForm.value).subscribe(function (response) {
            console.log("here response after add annonce", response);
            if (response.message == "demande saved with success") {
                _this.router.navigate(['assure-profile']);
            }
            else {
                _this.errorMsg = "Something went wrong with your annonce try again later";
            }
        });
    };
    AjoutModalComponent.ctorParameters = function () { return [
...
var AssureProfileComponent = /** @class */ (function () {
    function AssureProfileComponent(formBuilder, demandeService, router) {
        this.formBuilder = formBuilder;
        this.demandeService = demandeService;
        this.router = router;
        this.isLoading = true; // Added variable for loading status
    }
    AssureProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.connectedUser = JSON.parse(localStorage.getItem('connectedUser'));
        this.demandeService.getDemandeByUserId(this.connectedUser._id).subscribe(function (response) {
            _this.demandesTab = response.demandes;
            localStorage.setItem('demandes', JSON.stringify(_this.demandesTab));
        });
    ...
    AssureProfileComponent.prototype.loading = function () {
        var _this = this;
        setTimeout(function () {
            _this.isLoading = false; // Set isLoading to false after 5 seconds
            _this.userDemandes = JSON.parse(localStorage.getItem('demandes'));
        }, 6000); // 5 seconds delay
    };
    AssureProfileComponent.prototype.reloading = function () {
        this.isLoading = true;
    };
    AssureProfileComponent.prototype.onImageSelected = function (event) {
        var _this = this;
    ...
    AssureProfileComponent.prototype.facturation = function (m) {
        console.log('Facture button clicked!', m);
        var facturationValue;
        ...
        var titleWidth = doc.getStringUnitWidth('Facture') * 18 / doc.internal.scaleFactor;
        ...
        var headers = ['Prestataire', 'Type', 'Montant', 'Justif'];
        // Define the table data
        var data = [
            [m.prestataire, m.type, m.montant.toString(), m.justif],
        ];
        // Calculate the table column widths and row height
        var columnWidths = [50, 40, 40, 60];
        var rowHeight = 10;
        // Calculate the table position
        var startX = (doc.internal.pageSize.getWidth() - columnWidths.reduce(function (a, b) { return a + b; }, 0)) / 2;
        var startY = titleY + 20;
        ...
        var facturationText = "Facturation: " + facturationValue;
        var facturationTextWidth = doc.getStringUnitWidth(facturationText) * 12 / doc.internal.scaleFactor;
        var facturationTextX = doc.internal.pageSize.getWidth() - facturationTextWidth - 10;
        var facturationTextY = currentY + 20;
        doc.text(facturationText, facturationTextX, facturationTextY, { align: 'right' });
        // Save the PDF file
        doc.save('facturation.pdf');
    };
    AssureProfileComponent.ctorParameters = function () { return [
...
var AssureurProfileComponent = /** @class */ (function () {
    function AssureurProfileComponent(demandeService, router, rejectsService) {
        this.demandeService = demandeService;
        this.router = router;
    ...
    AssureurProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.connectedUser = JSON.parse(localStorage.getItem('connectedUser'));
        setTimeout(function () {
            _this.isLoading = false; // Set isLoading to false after 10 seconds
            _this.demandesWithUsers = JSON.parse(localStorage.getItem('demandes'));
        }, 3000); // 5 seconds delay
        this.demandeService.getAllDemandesWithUsers().subscribe(function (response) {
            _this.demandesTab = response.AllDemandesWithUser;
            localStorage.setItem('demandes', JSON.stringify(_this.demandesTab));
        });
    };
    // ------- confirm demande
    AssureurProfileComponent.prototype.confirmDemande = function (idDemande) {
        var _this = this;
        var noth;
        this.demandeService.confirmDemande(idDemande, noth).subscribe(function (response) {
            if (response.message == "1") {
                _this.demandesWithUsers = _this.demandesWithUsers.filter(function (m) { return m._id !== idDemande; });
            }
            else {
    ...
    // -------- reject demande
    AssureurProfileComponent.prototype.toggleRejectionTextArea = function (demandeId) {
    ...
    AssureurProfileComponent.prototype.rejectDemande = function (idDemande, cause) {
        var _this = this;
        this.showRejectionTextArea = false;
        this.rejectedDemandeId = '';
        this.rejectionCause = '';
        ...
        this.rejectsService.addRejection(this.rejectionForm).subscribe(function (response) {
        ...
        // ---------------Update the status--------------------------------
        var noth;
        this.demandeService.rejectDemande(idDemande, noth).subscribe(function (response) {
            if (response.message == "1") {
                _this.router.navigate(['assureur-profile']);
            }
            else {
                alert("Error updating command status");
            }
    ...
    AssureurProfileComponent.ctorParameters = function () { return [
        { type: src_app_Services_demande_service__WEBPACK_IMPORTED_MODULE_3__["DemandeService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    ...
    return AssureurProfileComponent;
}());
...
var ContacComponent = /** @class */ (function () {
    function ContacComponent() {
    }
    ContacComponent.prototype.ngOnInit = function () {
    };
...
var DetailDemandeComponent = /** @class */ (function () {
    function DetailDemandeComponent(router, route, rejectService) {
        this.router = router;
        this.route = route;
        this.rejectService = rejectService;
    }
    DetailDemandeComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.route.paramMap.subscribe(function (params) {
            _this.idDemande = params.get('id');
        });
        console.log("here", this.idDemande);
        this.rejectService.getRejectionByDemandeId(this.idDemande).subscribe(function (response) {
            _this.rejectionTab = response.rejection;
            _this.rejection = Array.isArray(_this.rejectionTab) ? _this.rejectionTab : [_this.rejectionTab];
            localStorage.setItem('rejection', JSON.stringify(_this.rejectionTab));
        });
    };
    DetailDemandeComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var ErrorComponentComponent = /** @class */ (function () {
    function ErrorComponentComponent() {
    }
    ErrorComponentComponent.prototype.ngOnInit = function () {
    };
    ...
    return ErrorComponentComponent;
}());
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.userService.login(this.userForm.value).subscribe(function (response) {
            console.log('response after login', response);
            if (response.message != "2") {
                _this.errorMsg = "Please check Email / Mot de Passe";
            }
            else {
                ...
                if (response.user.role == "Assureur") {
                    _this.navigateWithRefresh("assureur-profile");
                }
                else {
                    _this.navigateWithRefresh("assure-profile");
                }
            }
        });
    };
    ;
    LoginComponent.prototype.navigateWithRefresh = function (path) {
        var urlTree = this.router.createUrlTree([path]);
...
var ProposComponent = /** @class */ (function () {
    function ProposComponent() {
    }
    ProposComponent.prototype.ngOnInit = function () {
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.signup = function () {
        var _this = this;
        this.userService.signup(this.userForm.value, this.userForm.value.img).subscribe(function (response) {
            console.log("here response after signup", response);
            if (response.message == "user saved with success") {
                _this.router.navigate(['/login']);
            }
            else {
                _this.errorMsg = "Email Already Exist";
            }
        });
    };
    RegisterComponent.prototype.onImageSelected = function (event) {
        var _this = this;
        var file = event.target.files[0];
        console.log("here file", file);
        this.userForm.patchValue({ img: file });
